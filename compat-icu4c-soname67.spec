...
Requires: compat-icu4c-soname67-lib = %{version}-%{release}
Requires: compat-icu4c-soname67-license = %{version}-%{release}
...
%package lib
Summary: lib components for the compat-icu4c-soname67 package.
Group: Libraries
Requires: compat-icu4c-soname67-license = %{version}-%{release}

%description lib
lib components for the compat-icu4c-soname67 package.


%package license
Summary: license components for the compat-icu4c-soname67 package.
Group: Default

%description license
license components for the compat-icu4c-soname67 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664891792
...
cp %{_builddir}/icu/license.html %{buildroot}/usr/share/package-licenses/compat-icu4c-soname67/06e7821c4127e21850f5c981698443b6f31e0ef1 || :
pushd source
%make_install
popd
...
rm -f %{buildroot}*/usr/lib64/icu/67.1/Makefile.inc
rm -f %{buildroot}*/usr/lib64/icu/67.1/pkgdata.inc
...
rm -f %{buildroot}*/usr/share/icu/67.1/LICENSE
rm -f %{buildroot}*/usr/share/icu/67.1/config/mh-linux
rm -f %{buildroot}*/usr/share/icu/67.1/install-sh
rm -f %{buildroot}*/usr/share/icu/67.1/mkinstalldirs
...
/usr/share/package-licenses/compat-icu4c-soname67/06e7821c4127e21850f5c981698443b6f31e0ef1
/usr/share/package-licenses/compat-icu4c-soname67/e38052bb1365b1f2475d83fc2683c04d91b0f5f4
